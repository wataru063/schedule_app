...
RSpec.describe "Orders", type: :request do
  ...
  describe "GET #new" do
    subject { get new_order_path, xhr: true, params: { facility_id: order.facility_id } }
  ...
  describe "POST #create" do
    subject { post orders_path, xhr: true, params: order_params }
    ...
    context "as a logged_in user" do
      ...
      context "who is in charge" do
        ...
        context 'with invalid params' do
          ...
          it { is_expected.to render_template 'shared/_error_messages', 'orders/create' }
